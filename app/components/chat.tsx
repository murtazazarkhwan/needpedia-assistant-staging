...
const Chat = ({
    ...
    const maxTokens = Number(process.env.NEXT_PUBLIC_MAX_TOKENS) || 4000;
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data.tokens > 0) {
                ...
                const messageText = `You have exceeded your token limit. Please try again in 24 hours to continue.`;
                setMessages((prevMessages) => [
                    ...prevMessages,
                    {
                        role: 'assistant',
